...
const translations = {
  en: {
    ...
    'dish.2.desc': 'A rich Filipino stew dish made with beef and vegetables simmered in tomato sauce.',
    'dish.3.name': 'Lumpiang Togue',
    'dish.3.desc': 'A Filipino national spring roll, made by rolling up minced pork and vegetables into thin strips and deep-frying them.',
    ...
    'location.dinner': 'Dinner: 5:30 PM - 8:30 PM',
    'location.last2': 'Last Order: 8:00 PM',
  ...
  ja: {
    ...
    'mission.label': 'ミッション',
    'mission.title': '上質な牛肉と技、温かさで大切なお客さまをお迎えします。',
    'mission.text': 'リュウ箱根レストランでは、箱根を訪れるお客さまや地元の皆さまに、日本料理とフィリピン料理のおいしいセットメニューを提供します。最新の厨房設備を活用し、早く、安全で、質の高いサービスを実現することで、お店をより良く成長させていきます。日本らしい温かいおもてなしと、フィリピンらしい親しみのあるサービスを大切にし、二つの文化の味わいを組み合わせた料理で私たちらしさを表現します。良質な地元食材を活かして地域を大切にし、スタッフにも愛情と敬意をもって接することで、お客さまに最高の時間をお届けします。',
    'values.marker': 'VALUES',
    ...
    'menu.4.title': '和風ビーフシチューセット',
    'menu.4.text': '牛肉と野菜をやわらかく煮込んだ、旨みたっぷりの和風ビーフシチューです。',
    'ala.label': '和の定番',
    'ala.title': '和食アラカルト',
    ...
    'ala.4.name': '和風ビーフシチュー',
    'ala.4.desc': '牛肉と野菜をやわらかく煮込んだ、旨みたっぷりの和風ビーフシチューです。',
    'ala.5.name': '味噌汁',
    ...
    'set.2.desc': '牛肉と野菜をトマトソースで煮込んだ、フィリピンの濃厚なシチュー料理です。',
    ...
    'dish.2.desc': '牛肉と野菜をトマトソースで煮込んだ、フィリピンの濃厚なシチュー料理です。',
    ...
    'location.dinner': 'ディナー: 17:30 - 20:30',
    'location.last2': 'ラストオーダー: 20:00',
...
const revealTargets = document.querySelectorAll('.story-container, .story-image-large, .story-image-small, .vision-container, .vision-panel, .value-item, .menu-container, .menu-item, .drinks-menu, .location-container, .location-address, .location-map, .showcase-header');
