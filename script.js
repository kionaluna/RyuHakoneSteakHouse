...
const translations = {
  en: {
    ...
    'about.text': 'At Ryu Hakone, we bring together the comforting flavors of Japanese and Filipino cuisine. Our restaurant serves special set meals that combine the best of both worlds, giving you a unique and satisfying dining experience. Located in the beautiful area of Hakone, we are dedicated to serving delicious food made with care and offering a warm, welcoming space for all our guests. Whether you are looking for a taste of traditional Japanese hospitality or the heartwarming flavors of the Philippines, our set meals are crafted to make you feel right at home. Come and share a delicious meal with us!',
    'about.more': 'More About Us',
    'purpose.marker': 'PURPOSE',
    'purpose.label': 'Our Purpose',
    'purpose.title': 'VISION & MISSION',
    'vision.label': 'Vision for Ryu Hakone Restaurant',
    'vision.title': 'Vision',
    'vision.text': 'To be the most loved restaurant in Hakone where families and friends connect over delicious, homemade Japanese and Filipino set meals.',
    'mission.label': 'Mission for Ryu Hakone Restaurant',
    'mission.title': 'Mission',
    'mission.text': 'At Ryu Hakone Restaurant, we serve locals and travelers in Hakone with delicious Japanese and Filipino set meals. By using modern kitchen technology to ensure fast, safe, and high-quality service, we keep our business strong and growing. We believe in sharing warm Japanese hospitality and friendly Filipino service. Our special mix of flavors is what makes us stand out. We care for our community by using good, local ingredients, and we treat our team with love and respect so they can give you the best experience.',
    ...
    'menu.intro': 'Our menu is grouped into Set Meals, Ala Carte, and Drinks. All listed prices include tax.',
    'menu.group.set': 'Set Meals',
    'menu.group.ala': 'Ala Carte',
    'menu.group.drinks': 'Drinks',
    'menu.panel.japaneseSets': 'Japanese sets',
    'menu.1.title': 'Japanese Beef Steak Set (Picanha)',
    'menu.1.sub': 'Set Meal',
    'menu.1.text': 'Perfectly tender and this part is located above the rump. It has a lot of marbling (fat).',
    'menu.2.title': 'Japanese Beef Steak Set (Rump)',
    'menu.2.sub': 'Set Meal',
    'menu.2.text': 'Perfectly tender and full of meaty flavor. A lean meat from the rump.',
    ...
    'menu.4.title': 'Japanese Beef Stew Set',
    'menu.4.text': 'A Japanese stew featuring tender beef and vegetables, simmered until soft and full of flavor.',
    ...
    'ala.1.desc': 'Perfectly tender and this part is located above the rump. It has a lot of marbling (fat).',
    'ala.2.name': 'Japanese Beef Steak (Rump)',
    'ala.2.desc': 'Perfectly tender and full of meaty flavor. A lean meat from the rump.',
    ...
    'ala.4.name': 'Japanese Beef Stew',
    'ala.4.desc': 'A Japanese stew featuring tender beef and vegetables, simmered until soft and full of flavor.',
    ...
    'set.2.desc': 'A rich Filipino stew dish made with beef and vegetables simmered in tomato sauce.',
    'set.3.name': 'Lumpiang Togue Set',
    'set.3.desc': 'A Filipino national spring roll, made by rolling up minced pork and vegetables into thin strips and deep-frying them.',
    ...
    'drink.4.name': 'Japanese Rice Wine Glass',
  ...
  ja: {
    ...
    'menu.title': 'メニュー',
    'menu.intro': 'メニューは「セットメニュー」「単品メニュー」「ドリンク」の3つに分かれています。表示価格はすべて税込です。',
    'menu.group.set': 'セットメニュー',
    'menu.group.ala': '単品メニュー',
    'menu.group.drinks': 'ドリンク',
    'menu.panel.japaneseSets': '日本のセット',
    'menu.1.title': '国産ステーキセット(イチボ)',
    'menu.1.sub': 'セットメニュー',
    'menu.1.text': 'ランプの上に位置する部位。サシ（脂）が多く、柔らかい。',
    'menu.2.title': '国産ステーキセット(ランプ)',
    'menu.2.sub': 'セットメニュー',
    'menu.2.text': 'お尻の赤身肉。柔らかく、肉の旨味が強い。',
    'menu.3.title': '国産ハンバーグセット',
    'menu.3.sub': 'セットメニュー',
    'menu.3.text': '口の中でとろける、やわらかく風味豊かなハンバーグ。定番の和風ソースでどうぞ。',
    'menu.4.title': '国産ビーフシチューセット',
    'menu.4.text': '牛肉と野菜をやわらかく煮込んだ、旨みたっぷりのビーフシチューです。',
    'menu.note.title': '表示価格はすべて税込',
    'menu.note.text': 'すべてのメニューページの価格は税込表示です。',
    'ala.label': '和の定番',
    'ala.title': 'アラカルト',
    'ala.1.name': '国産ステーキ(イチボ)',
    'ala.1.desc': 'ランプの上に位置する部位。サシ（脂）が多く、柔らかい。',
    'ala.2.name': '国産ステーキ(ランプ)',
    'ala.2.desc': 'お尻の赤身肉。柔らかく、肉の旨味が強い。',
    'ala.3.name': '国産ハンバーグ',
    'ala.3.desc': '口の中でとろける、やわらかく風味豊かなハンバーグ。定番の和風ソースでどうぞ。',
    'ala.4.name': '国産ビーフシチュー',
    'ala.4.desc': '牛肉と野菜をやわらかく煮込んだ、旨みたっぷりのビーフシチューです。',
    'ala.5.name': '味噌汁',
    ...
    'set.label': 'セットでご提供',
    'set.title': 'フィリピンセット',
    'set.1.name': 'ポークアドボーセット',
    'set.1.desc': '豚肉を酢、醤油、ニンニクなどで煮込んだフィリピンの代表的な家庭料理。',
    'set.2.name': 'ビーフカルデレータセット',
    'set.2.desc': '牛肉と野菜をトマトソースで煮込んだフィリピンの濃厚なシチュー料理。',
    'set.3.name': 'フィリピン風野菜春巻きセット',
    'set.3.desc': '豚ひき肉や野菜を細く巻いて揚げた、フィリピンの国民的な揚げ春巻き。',
    'dish.label': 'フィリピンの定番',
    'dish.title': 'フィリピン料理',
    'dish.1.name': 'ポークアドボ',
    ...
    'soft.7.name': 'アイスコーヒー',
    'dessert.title': 'デザート',
    'dessert.1.name': 'ジュナの自家製プリン (ホール)',
    'dessert.2.name': 'ジュナの自家製プリン (ハーフ)',
    'location.title': 'アクセス',
...
const i18nTargets = [
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(1) .drinks-item-sub', key: 'drink.1.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(2) .drinks-item-sub', key: 'drink.2.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(3) .drinks-item-sub', key: 'drink.3.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(4) .drinks-item-sub', key: 'drink.4.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(5) .drinks-item-sub', key: 'drink.5.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(6) .drinks-item-sub', key: 'drink.6.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(7) .drinks-item-sub', key: 'drink.7.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(8) .drinks-item-sub', key: 'drink.8.sub' },
  ...
  { selector: '#menu .drinks-menu--separate[aria-labelledby="drinks-menu-title"] .drinks-item:nth-child(9) .drinks-item-sub', key: 'drink.9.sub' },
